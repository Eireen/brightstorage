...
exports.imagePreview = '<tr><td><img src="{src}" style="max-width: 128px; max-height: 128px;"></td><td><input type="text" value="{link}" style="width: 400px"></td><td><a href="{remove_url}">Remove</a></td></tr>';
